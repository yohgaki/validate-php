...
PHP_MINIT_FUNCTION(validate)
{
	...
	REGISTER_LONG_CONSTANT("VALIDATE_URL", VALIDATE_URL, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("VALIDATE_EMAIL", VALIDATE_EMAIL, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("VALIDATE_IP", VALIDATE_IP, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("VALIDATE_MAC", VALIDATE_MAC, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("VALIDATE_DOMAIN", VALIDATE_DOMAIN, CONST_CS | CONST_PERSISTENT);
	...
	/* Complex string value options */
	REGISTER_LONG_CONSTANT("VALIDATE_URL_ALLOW_HTTPS_SCHEME", VALIDATE_URL_ALLOW_HTTPS_SCHEME, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("VALIDATE_URL_ALLOW_HTTP_SCHEME", VALIDATE_URL_ALLOW_HTTP_SCHEME, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("VALIDATE_URL_ALLOW_ANY_SCHEME", VALIDATE_URL_ALLOW_ANY_SCHEME, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("VALIDATE_URL_ALLOW_HOST", VALIDATE_URL_ALLOW_HOST, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("VALIDATE_URL_ALLOW_PATH", VALIDATE_URL_ALLOW_PATH, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("VALIDATE_URL_ALLOW_QUERY", VALIDATE_URL_ALLOW_QUERY, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("VALIDATE_URL_ALLOW_IDN", VALIDATE_URL_ALLOW_IDN, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("VALIDATE_DOMAIN_HOSENAME", VALIDATE_DOMAIN_HOSTNAME, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("VALIDATE_IP_IPV4", VALIDATE_IP_IPV4, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("VALIDATE_IP_IPV6", VALIDATE_IP_IPV6, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("VALIDATE_IP_ALLOW_RESERVED", VALIDATE_IP_ALLOW_RESERVED, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("VALIDATE_IP_ALLOW_PRIVATE", VALIDATE_IP_ALLOW_PRIVATE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("VALIDATE_EMAIL_ALLOW_UTF8", VALIDATE_EMAIL_ALLOW_UTF8, CONST_CS | CONST_PERSISTENT);
